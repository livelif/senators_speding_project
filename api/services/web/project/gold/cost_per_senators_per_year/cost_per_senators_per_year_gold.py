...
class CostPerSenatorsPeryear():
    ...
    def execute(self):
        try:
            ...
            employee_liquid = employee_liquid.select("VINCULO", "SENADOR", "TOTAL", "FILE_YEAR")\
            ...
            employee_liquid.repartition(1).write.mode("overwrite")\
                .parquet("project/database/gold/cost_per_senators_per_year_gold")

            return generateResponse(msg="How much cost the senators employee per year wrote in gold layer")
